...
def non_admin_user_search(driver, Users, ISAAC_WEB, WAIT_DUR):
    ...
    not_allowed = [Users.Student, Users.Teacher]
    ...
    for role in roles:
        try:
            ...
            time.sleep(WAIT_DUR)
            assert submit_login_form(driver, user=role, wait_dur=WAIT_DUR)
            ...
            log(ERROR, "Can't login to access User Manager!")
            return False
